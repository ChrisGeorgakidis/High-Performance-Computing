...
////////////////////////////////////////////////////////////////////////////////
__global__ void convolutionRow(float *Input, float *Filter, float *Output)
{
  //Row Convolution Code
...
////////////////////////////////////////////////////////////////////////////////
__global__ void convolutionColumn(float *Input, float *Filter, float *Output)
{
  //Column Convolution
}
...
int main(int argc, char **argv) {
  ...
  *d_OutputGPU;
  ...
  #pragma   //GPU Computation
  {
    ...
    convolutionRow <<< numBlocks, threadsPerBlock >>> (d_Input, d_Filter, d_Buffer);
    ...
    //execute grid of numBlocks blocks of threadsPerBlock threads each
    convolutionColumn <<< numBlocks, threadsPerBlock >>> (d_Buffer, d_Filter, d_OutputGPU);
