	...
	for (i=1; i<temp5; i+=1) {
		...
		for (j=1; j<temp5; j+=1 ) {
			...
			temp1 = input[temp3 + j - temp4] * horiz_operator[0][0]
			 		+ input[temp3 + j - SIZE] * horiz_operator[0][1]
					+ input[temp3 + j - temp5] * horiz_operator[0][2]
			 		+ input[temp3 + j - 1] * horiz_operator[1][0]
			 		+ input[temp3 + j] * horiz_operator[1][1]
			 		+ input[temp3 + j + 1] * horiz_operator[1][2]
			 		+ input[temp3 + j + temp5] * horiz_operator[2][0]
			 		+ input[temp3 + j + SIZE] * horiz_operator[2][1]
			 		+ input[temp3 + j + temp4] * horiz_operator[2][2];


			temp2 = input[temp3 + j - temp4] * vert_operator[0][0]
					+ input[temp3 + j - SIZE] * vert_operator[0][1]
					+ input[temp3 + j - temp5] * vert_operator[0][2]
					+ input[temp3 + j - 1] * vert_operator[1][0]
					+ input[temp3 + j] * vert_operator[1][1]
					+ input[temp3 + j + 1] * vert_operator[1][2]
					+ input[temp3 + j + temp5] * vert_operator[2][0]
					+ input[temp3 + j + SIZE] * vert_operator[2][1]
					+ input[temp3 + j + temp4] * vert_operator[2][2];
